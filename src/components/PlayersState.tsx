...
const PlayersState = () => {
  ...
  const handleSellClick = () => {
    ...
    return(
      <div className={`flex flex-col items-center justify-center w-64 h-64 border border-gray-300 rounded-lg shadow-lg p-4 ${buyClicked ? 'bg-green-200' : sellClicked ? 'bg-red-200' : 'bg-transparent'}`}>
